...
export const PACKAGES: Package[] = [
  {
    ...
    valueCallout: 'Includes $348 in hosting & subscription value',
    afterNote: 'After 6 months — hosting included with active Premium ($39/mo), or $19/mo hosting only',
  ...
  },
  {
    ...
    valueCallout: 'Includes $612 in hosting & subscription value',
    afterNote: 'After 9 months — hosting included with active Premium ($39/mo), or $29/mo hosting only',
    highlight: true,
  ...
  },
  {
    ...
    features: [
      ...
      'Advanced SEO (keyword research, image optimization, sitemap)',
      'AI search optimization (structured for AI-powered search results)',
      '2 feedback rounds + 1 post-delivery revision',
      'Includes 12 months hosting + Premium subscription',
    ],
    valueCallout: 'Includes $936 in hosting & subscription value',
    afterNote: 'After 12 months — hosting included with active Premium ($39/mo), or $39/mo hosting only',

  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            Visit the <Link href="/directory" className="text-primary underline underline-offset-2">Directory</Link> page
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            ourselves. Look for the &ldquo;Book Now&rdquo; or &ldquo;Visit Website&rdquo; button on a listing&apos;s
      ...
      },
      {
        ...
        answer: (
          <p>
            You can flag a listing for review using the &ldquo;Report listing&rdquo; link on any
    ...
    items: [
      {
        ...
        answer: (
          <p>
            Go to the{' '}
            <Link href="/list-your-practice" className="text-primary underline underline-offset-2">
              List Your Practice
            </Link>{' '}
      ...
      },
      {
        ...
        answer: (
          <p>
            If you find an existing listing for your practice, click the &ldquo;Claim this
            listing&rdquo; link on the profile page. You&apos;ll be asked to verify your identity and
    ...
    items: [
      {
        ...
        answer: (
          <p>
            Log in to your dashboard and go to <strong>Billing</strong>. Click &ldquo;Cancel
            subscription.&rdquo; Your listing will remain active at your current tier until the
      ...
      },
      {
        ...
        answer: (
          <p>
            Go to <strong>Billing</strong> in your dashboard and click &ldquo;Manage billing.&rdquo;
    ...
    items: [
      {
        ...
        answer: (
          <p>
            ...
            <Link href="/auth" className="text-primary underline underline-offset-2">sign-in page</Link>.
